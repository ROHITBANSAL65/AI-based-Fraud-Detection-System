...
app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql+psycopg2://postgres:#Aanchal4@localhost:5432/fraud_detection_db'
...
class AadhaarVerificationSystem:
    def __init__(self, upload_folder, classifier_path, detector_path):
        ...
        # Initialize models
        self.classifier = YOLO("D:\\Fraud-Management-System-main\\models\\classifier.pt")
        self.detector = YOLO("D:\\Fraud-Management-System-main\\models\\detector.pt")
